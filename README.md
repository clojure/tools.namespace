...
Latest stable release is [1.4.0](https://github.com/clojure/tools.namespace/tree/v1.4.0)
...
Git master branch is at **1.4.1-SNAPSHOT**
...
Leiningen dependency information for development snapshots:
    ...
    :dependencies [[org.clojure/tools.namespace "1.4.1-SNAPSHOT"]]
